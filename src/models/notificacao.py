...
class Notificacao(Base):
    ...
    tipo_evento: Mapped[TipoEvento] = mapped_column(Enum(TipoEvento, name="tipoevento"))
    destinatario_user_id: Mapped[int | None] = mapped_column(ForeignKey("users.id"), nullable=True)
