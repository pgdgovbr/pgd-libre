...
class User(Base):
    ...
    oauth_sub: Mapped[str | None] = mapped_column(String(255), unique=True, nullable=True)
    ...
    cod_unidade_autorizadora: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
